  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto flex flex-col items-center">
        ...
        <div className="mt-10">
          <Button asChild size="lg" className="px-8 py-6 text-base font-bold bg-[#2f6b65] hover:bg-[#255651] text-white rounded-full hover:shadow-[0_0_35px_rgba(47,107,101,0.35)] transition-all duration-300">
