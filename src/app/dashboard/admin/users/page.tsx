...
import { Search, Filter, MoreVertical, Lock, Unlock, Mail } from "lucide-react";
import { Button } from "@/components/ui/button";

export default function UsersManagementPage() {
  const users = [
    { id: 1, name: "Matheus Silva", email: "matheus@exemplo.com", role: "ADMIN", status: "Ativo", progress: "100%", lastLogin: "Hoje" },
    { id: 2, name: "Ana Beatriz", email: "ana@empresa.com", role: "STUDENT", status: "Ativo", progress: "45%", lastLogin: "Ontem" },
    { id: 3, name: "Lucas Rocha", email: "lucas@email.com", role: "STUDENT", status: "Bloqueado", progress: "12%", lastLogin: "Há 3 dias" },
    { id: 4, name: "Juliana Santos", email: "ju@rh.com.br", role: "COMPANY_ADMIN", status: "Ativo", progress: "88%", lastLogin: "Hoje" },
  ];
                ...
                >
                  ...
                  <td className="py-4 px-4 text-right">
                    <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <Button variant="ghost" size="icon" className="h-8 w-8 text-white/40 hover:text-rose-400">
                        {user.status === 'Ativo' ? <Lock className="w-4 h-4" /> : <Unlock className="w-4 h-4" />}
                      </Button>
                      <Button variant="ghost" size="icon" className="h-8 w-8 text-white/40 hover:text-white">
